...
public class OwnerHomeScreenGUI extends JFrame {
...
//////////Rentals Menu Items/////////////////////////////////////////////////////////////////
		...
		processNewRental.addActionListener(ae -> {
			...
			int tenIdx = Integer.parseInt(JOptionPane.showInputDialog(
					"Enter a tenant ID number " + " between 1 and " + OwnerHomeScreenGUI.tenantsAvailable.size()));
			// pick a property
			...
			Rental propertyRental = new Rental(propertyAvailable.get(tenIdx - 1),
					OwnerHomeScreenGUI.tenantsAvailable.get(propIdx - 1));
			...
			tenantList.add(OwnerHomeScreenGUI.tenantsAvailable.get(propIdx - 1));
			// remove taken tenant from tenantAvailable list
			OwnerHomeScreenGUI.tenantsAvailable.remove(OwnerHomeScreenGUI.tenantsAvailable.get(propIdx - 1));
	...
	private void saveOwnersFile() {
		try {
			...
			os.writeObject(OwnerHomeScreenGUI.ownerList);
			os.close();
		} catch (Exception e) {
	...
	private void savePropertiesFile() {
		try {
			...
			os.writeObject(OwnerHomeScreenGUI.propertyAvailable);
			os.close();
		} catch (Exception e) {
	...
	private void savePropertiesListFile() {
		try {
			...
			os.writeObject(OwnerHomeScreenGUI.propertyList);
			os.close();
		} catch (Exception e) {
	...
	private void savePropertiesLetFile() {
		try {
			...
			os.writeObject(OwnerHomeScreenGUI.propertyLet);
			os.close();
		} catch (Exception e) {
	...
	private static void saveTenantsFile() {
		try {
			...
			os.writeObject(OwnerHomeScreenGUI.tenantsAvailable);
			os.close();
		} catch (Exception e) {
	...
	private void saveTenantsListFile() {
		try {
			...
			os.writeObject(OwnerHomeScreenGUI.tenantList);
			os.close();
		} catch (Exception e) {
	...
	private void saveRentalsFile() {
		try {
			...
			os.writeObject(OwnerHomeScreenGUI.rentalList);
			os.close();
		} catch (Exception e) {
	...
	private void loadOwnersFile() {
		...
		try {
			...
			OwnerHomeScreenGUI.ownerList = (ArrayList<Owner>) is.readObject();// note the typecast
	...
	private void loadPropertiesListFile() {
		...
		try {
			...
			OwnerHomeScreenGUI.propertyList = (ArrayList<Property>) is.readObject();// note the typecast
			is.close(); // Close the Input Stream
	...
	private void loadPropertiesFile() {
		...
		try {
			...
			OwnerHomeScreenGUI.propertyAvailable = (ArrayList<Property>) is.readObject();// note the typecast
			is.close(); // Close the Input Stream
			// JOptionPane.showMessageDialog(null, "Properties successfully loaded from
			// file\n");
		} catch (Exception e) {
	...
	private void loadPropertiesLetFile() {
		...
		try {
			...
			OwnerHomeScreenGUI.propertyLet = (ArrayList<Property>) is.readObject();// note the typecast
			is.close(); // Close the Input Stream
			// JOptionPane.showMessageDialog(null, "Properties successfully loaded from
			// file\n");
		} catch (Exception e) {
	...
	private void loadTenantsFile() {
		...
		try {
			...
			OwnerHomeScreenGUI.tenantsAvailable = (ArrayList<Tenant>) is.readObject();// note the typecast
			is.close(); // Close the Input Stream
	...
	private void loadTenantsListFile() {
		...
		try {
			...
			OwnerHomeScreenGUI.tenantList = (ArrayList<Tenant>) is.readObject();// note the typecast
			is.close(); // Close the Input Stream
			// JOptionPane.showMessageDialog(null, "Tenants successfully loaded from
			// file\n");
		} catch (Exception e) {
	...
	private void loadRentalsFile() {
		...
		try {
			...
			OwnerHomeScreenGUI.rentalList = (ArrayList<Rental>) is.readObject();// note the typecast
			is.close(); // Close the Input Stream
